...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "setForm".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SetForm#execute()} method to invoke the remote operation.
   *
   * @param formName
   * @return the request
   */
  public SetForm setForm(java.lang.String formName) throws java.io.IOException {
    SetForm result = new SetForm(formName);
    initialize(result);
    return result;
  }

  public class SetForm extends MyApiRequest<com.example.katya.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "setForm/{formName}";

    /**
     * Create a request for the method "setForm".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SetForm#execute()} method to invoke the remote operation. <p>
     * {@link
     * SetForm#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param formName
     * @since 1.13
     */
    protected SetForm(java.lang.String formName) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.katya.myapplication.backend.myApi.model.MyBean.class);
    ...
    @Override
    public SetForm setAlt(java.lang.String alt) {
      return (SetForm) super.setAlt(alt);
    }

    @Override
    public SetForm setFields(java.lang.String fields) {
      return (SetForm) super.setFields(fields);
    }

    @Override
    public SetForm setKey(java.lang.String key) {
      return (SetForm) super.setKey(key);
    }

    @Override
    public SetForm setOauthToken(java.lang.String oauthToken) {
      return (SetForm) super.setOauthToken(oauthToken);
    }

    @Override
    public SetForm setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SetForm) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SetForm setQuotaUser(java.lang.String quotaUser) {
      return (SetForm) super.setQuotaUser(quotaUser);
    }

    @Override
    public SetForm setUserIp(java.lang.String userIp) {
      return (SetForm) super.setUserIp(userIp);
    }
    ...
    public SetForm setFormName(java.lang.String formName) {
      this.formName = formName;
      return this;
    }

    @Override
    public SetForm set(String parameterName, Object value) {
      return (SetForm) super.set(parameterName, value);
    }
  }
